...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        with connection.cursor() as cursor:
            ...
            categories = {
                "Образование и курсы": ["Видеоуроки и лекции", "Электронные книги", "Вебинары и мастер-классы"],
                "Здоровье и фитнес": ["Программы тренировок", "Рецепты и диеты", "Психологические советы и медитация"],
                "Финансы и инвестиции": ["Финансовые стратегии", "Инвестиционные гайды", "Анализ рынка"],
                ...
                "Искусство и креатив": ["Уроки рисования и дизайна", "Музыкальные курсы", "Фотография и видеосъемка"],
